...
if __name__ == "__main__":
    password = "aqil@noon"
    run_scp("frontend/package.json", "aqil@187.127.154.55:/tmp/package.json")
    
    commands = [
        "mv /tmp/package.json /var/www/socialsched/frontend/package.json",
        "chown socialsched:socialsched-dev /var/www/socialsched/frontend/package.json",
