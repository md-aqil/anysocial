-- CreateEnum
CREATE TYPE "Platform" AS ENUM ('INSTAGRAM', 'FACEBOOK', 'LINKEDIN', 'TWITTER', 'TIKTOK', 'YOUTUBE', 'THREADS', 'PINTEREST', 'SNAPCHAT');
...
-- CreateIndex
CREATE INDEX "reel_series_userId_idx" ON "reel_series"("userId");
